...
## ChatGPT Prompt
Write a function that takes a string as input and returns true if all the characters in the string are unique, and false otherwise. Ignore case sensitivity but consider spaces and special characters.
